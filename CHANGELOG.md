...
- Make Trivy and Syft inspect the explicit native matrix platform when scanning
  pushed per-platform OCI indexes instead of their default Linux AMD64 target.
## [0.2.3] - 2026-07-31
...
[0.2.4]: https://github.com/192d-Wing/usg-est-issuer/compare/v0.2.3...v0.2.4
